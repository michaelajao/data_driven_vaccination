...
def calculate_all_metrics(actual, predicted, train_data, label, train_size, area_name):
    """Calculate metrics for each state."""
    print(f"\nMetrics for {label}:")
    mape, nrmse, mase, rmse, mae, mse = calculate_errors(actual, predicted, train_data, train_size, area_name)
    return mape, nrmse, mase, rmse, mae, mse
