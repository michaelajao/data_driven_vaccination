...
def plot_outputs(model, t, parameter_net, data, device, scaler):
    ...
    colors = [
        ...
        "green",
        "violet",
    ] * 6  # Use a list for colors in case you want to customize further
...
parameters_np, observed_model_output_scaled = plot_outputs(
    model, time_stamps, parameter_net, train_data, device, scaler
)
